...
export class HttpService extends HttpClient {
  ...
  authorize(): HttpClient {
    const authorizationInterceptor = this.injector.get(ApiAuthorizationInterceptor);
    return this.addInterceptor(authorizationInterceptor);
  }

  disableAuthorization(): HttpClient {
    return this.removeInterceptor(ApiAuthorizationInterceptor);
  }
